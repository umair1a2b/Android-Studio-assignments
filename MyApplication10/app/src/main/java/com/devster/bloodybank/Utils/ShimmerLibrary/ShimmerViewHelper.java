...
public class ShimmerViewHelper {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray a = view.getContext().obtainStyledAttributes(attributeSet, R.styleable.AppCompatTextView, 0, 0);
            if (a != null) {
                try {
                    reflectionColor = a.getColor(R.styleable.MaterialSpinner_ms_baseColor, DEFAULT_REFLECTION_COLOR);
                } catch (Exception e) {
